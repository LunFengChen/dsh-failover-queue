...
function QueuePanel({ state, api, t, onClose, embedded = false }) {
	...
	const filtered = (0, react.useMemo)(() => available.filter((row) => candidateMatches(row, query)), [available, query]);
	(0, react.useEffect)(() => {
		if (!menuOpen) return;
		const onDoc = (event) => {
	...
	const pickerLabel = !state.candidatesLoaded ? t("panel.add.loading") : available.length === 0 ? t("panel.add.none") : t("panel.add.placeholderCount", { count: available.length });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				...
				}), menuOpen && state.candidatesLoaded && available.length > 0 && menuPos !== null ? (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
						...
						role: "listbox",
						"aria-label": t("panel.add"),
						children: filtered.map((row) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
